...
<footer id="footer">
    <div id="footer-content">
        <a href="###" class="under_none" style="margin-right:20px; font-size: 18px;">이용약관</a> <span>|</span> 
        <a href="###" class="under_none" style="margin-right:20px; font-size: 18px;">블로그 서비스 운영정책</a> <span>|</span> 
